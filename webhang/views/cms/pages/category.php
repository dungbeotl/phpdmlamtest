  ...
  <h1 class="h3 mb-2 text-gray-800 d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="modal fade" id="addCategory" tabindex="-1" role="dialog" aria-labelledby="addCategoryModal" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <!-- Form add new    -->
        <form method="POST" action="http://localhost:90/projectsphp/webbanhang/webhang/controller/cms/category.php" enctype="multipart/form-data">
...
<script>
  function deleteCategory(id) {
    $.post("http://localhost:90/projectsphp/webbanhang/webhang/controller/cms/category.php", {
      id: id,
      action: "delete"
    }, function(data) {
      // console.log(data);
