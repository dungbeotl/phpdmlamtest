...
<div class="container">
    ...
    //     header('Location: http://localhost:90/projectsphp/webbanhang/webhang/views/pages/home.php');
    ...
    <div class="block block-breadcrumbs">
        <ul>
            <li class="home">
                <a href="http://localhost:90/projectsphp/webbanhang/webhang/views/pages/home.php"><i class="fa fa-home"></i></a>
                <span></span>
            </li>
    ...
    <div class="category-products tab-pane fade in active " id="row_gird">
                        ...
                        <div class="product-container">
                            <div class="product-left">
                                <div class="product-thumb">
                                    <a class="product-img" href="<?= 'http://localhost:90/projectsphp/webbanhang/webhang/views/pages/product_detail.php?product=' . $product->id ?>">
                            ...
                            <div class=" product-right">
                                <div class="product-name">
                                    <a title="View detail" href="<?= 'http://localhost:90/projectsphp/webbanhang/webhang/views/pages/product_detail.php?product=' . $product->id ?>"><?= $product->name ?></a>
                                </div>
                                <div class="price-box">
                                ...
                                <div class="product-button" style="padding: 2px;">
                                    <a class="button-radius btn-add-cart" href="<?= 'http://localhost:90/projectsphp/webbanhang/webhang/views/pages/product_detail.php?product=' . $product->id ?>" title="Add to Cart">Buy<span class="icon"></span></a>
                                </div>
                            </div>
                        </div>
                    </li>
        ...
        <?php } else { ?>
            ...
            <div style="width: 100%; background-color: white;  padding: 40px; margin-top: 10px;">
                <img src="http://localhost:90/projectsphp/webbanhang/webhang/upload/empty.jpg" style="width: 50%; margin-left:25%; margin-top: 30px;" alt="">
            </div>
        <?php } ?>
    </div>
</div>
