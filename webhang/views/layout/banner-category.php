                                ...
                                <ul class="home_categories">
                                    ...
                                    <?php foreach ($category_parents as $parent) { ?>
                                        <li style="position: relative;">
                                            <a class="dropdown-toggle" href="<?= 'http://localhost:90/projectsphp/webbanhang/webhang/views/pages/product_of_category.php?category=' . $parent->id ?>" title="">
                                            ...
                                            <ul class="dropdown-menu">
                                                <?php
                                                    ...
                                                    foreach ($category_childs as $child) {
                                                        ?>
                                                    <li>
                                                        <a href="<?= 'http://localhost:90/projectsphp/webbanhang/webhang/views/pages/product_of_category.php?category=' . $child->id ?>" style="vertical-align: middle; font-weight: bold;" title="">
