            ...
            <div class="">
                <div class="">
                    <ul class="top-bar-link top-bar-link-right dot">
                        <?php if (!$user) { ?>
                            <li><a href="http://localhost:90/projectsphp/webbanhang/webhang/views/pages/login.php">Sign in</a></li>
                            <li><a href="http://localhost:90/projectsphp/webbanhang/webhang/views/pages/login.php">Sign up</a></li>
                        <?php
                        } else {
                            ...
                            <li class="dropdown-item">
                                <form method="post" action="http://localhost:90/projectsphp/webbanhang/webhang/controller/user.php">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                            <div class="logo text-center">
                                <a href="http://localhost:90/projectsphp/webbanhang/webhang/views/pages/home.php">
                        ...
                        <div id="search_form" class="col-sm-6 col-md-7 col-lg-6 col-xs-12">
                            ...
                            <div class="box-radius advanced-search">
                                <form class="form-inline" method="get" action="http://localhost:90/projectsphp/webbanhang/webhang/views/pages/search.php">
                                    ...
                                    <div class="form-group search-input">
                                        <input name="keyword" type="text" placeholder="What are you looking for?" value="<?= isset($_REQUEST['keyword']) ? $_REQUEST['keyword'] : null ?>">
                                    </div>
                        ...
                        <div class="col-lg-2 col-md-2  col-sm-2 col-xs-12  left_bar_icon" style="justify-content: space-around; display: flex;">
                            ...
                            <div class="block-wrap-cart ">
                                <div class="">
                                    <a href="http://localhost:90/projectsphp/webbanhang/webhang/views/pages/cart.php" class="fa fa-shopping-cart shopping_icon not0">
