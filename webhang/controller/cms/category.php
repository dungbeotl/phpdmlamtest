...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
  ...
  if ($action == 'add') {
    ...
    $url_target = 'http://localhost:90/projectsphp/webbanhang/webhang/upload/category/';
    ...
    echo '<form method="POST" action="http://localhost:90/projectsphp/webbanhang/webhang/controller/cms/category.php" enctype="multipart/form-data"> 
