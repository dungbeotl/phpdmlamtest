...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
  ...
  if ($action == 'add') {
    ...
    $url_target = 'http://localhost:90/projectsphp/webbanhang/webhang/upload/banner/';
    ...
    echo '<form method="POST" action="http://localhost:90/projectsphp/webbanhang/webhang/controller/cms/Banner.php" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
           ...
           <input type="text" class="form-control" id="url_banner" value="' . $banner->url_banner . '" name="url_banner" placeholder="Enter url banner">
            </div>
          </div>
        </div>
